...
windbag_deps=src/ax25.o src/base64.o src/bigbuffer.o src/callsign.o src/chat.o src/config.o src/keygen.o src/keyring.o src/kiss.o src/main.o src/tty.o src/windbag.o
